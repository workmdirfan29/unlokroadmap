...
const initialNodes = [
  {
    id: "1",
    position: { x: 480, y: 20 },
    data: { label: "HTML Roadmap", icon: "📚" },
  },

  // Day 1: Introduction to HTML (Left)
  {
    id: "2",
    position: { x: 240, y: 100 },
    data: { label: "Day 1: Introduction to HTML", icon: "🌅" },
  },
  {
    id: "3",
    position: { x: 100, y: 200 },
    data: { label: "What is HTML?", icon: "📝" },
  },
  {
    id: "4",
    position: { x: 400, y: 200 },
    data: { label: "HTML Structure", icon: "📑" },
  },

  // Day 2: Basic Tags (Right)
  {
    id: "5",
    position: { x: 720, y: 100 },
    data: { label: "Day 2: Basic Tags", icon: "🔖" },
  },
  {
    id: "6",
    position: { x: 600, y: 200 },
    data: { label: "Headings (h1-h6)", icon: "🔤" },
  },
  {
    id: "7",
    position: { x: 840, y: 200 },
    data: { label: "Paragraphs (p)", icon: "📜" },
  },

  // Day 3: Formatting Text (Left)
  {
    id: "8",
    position: { x: 240, y: 300 },
    data: { label: "Day 3: Formatting Text", icon: "📝" },
  },
  {
    id: "9",
    position: { x: 100, y: 400 },
    data: { label: "Bold & Italics", icon: "🔠" },
  },
  {
    id: "10",
    position: { x: 400, y: 400 },
    data: { label: "Lists (ul, ol)", icon: "📋" },
  },

  // Day 4: Links and Navigation (Right)
  {
    id: "11",
    position: { x: 720, y: 300 },
    data: { label: "Day 4: Links and Navigation", icon: "🔗" },
  },
  {
    id: "12",
    position: { x: 600, y: 400 },
    data: { label: "Anchor Tags", icon: "🔗" },
  },
  {
    id: "13",
    position: { x: 840, y: 400 },
    data: { label: "Navigation Bars", icon: "🧭" },
  },

  // Day 5: Images and Media (Left)
  {
    id: "14",
    position: { x: 240, y: 500 },
    data: { label: "Day 5: Images and Media", icon: "🖼️" },
  },
  {
    id: "15",
    position: { x: 100, y: 600 },
    data: { label: "Adding Images", icon: "🖼️" },
  },
  {
    id: "16",
    position: { x: 400, y: 600 },
    data: { label: "Audio & Video", icon: "🎵" },
  },
  ...
  // Day 6: Tables (Right)
  {
    ...
    data: { label: "Day 6: Tables", icon: "📊" },
  },
  {
    id: "18",
    position: { x: 600, y: 600 },
    data: { label: "Table Structure", icon: "📋" },
  },
  {
    id: "19",
    position: { x: 840, y: 600 },
    data: { label: "Table Tags (tr, td)", icon: "📋" },
  },
  ...
  // Day 7: Forms (Left)
  {
    ...
    data: { label: "Day 7: Forms", icon: "📝" },
  },
  {
    id: "21",
    position: { x: 100, y: 800 },
    data: { label: "Form Elements", icon: "📋" },
  },
  {
    id: "22",
    position: { x: 400, y: 800 },
    data: { label: "Input Types", icon: "🔢" },
  },

  // Day 8: Semantic HTML (Right)
  {
    id: "23",
    position: { x: 720, y: 700 },
    data: { label: "Day 8: Semantic HTML", icon: "📄" },
  },

  // Day 9: HTML5 Features (Left)
  {
    id: "24",
    position: { x: 240, y: 900 },
    data: { label: "Day 9: HTML5 Features", icon: "✨" },
  },
  {
    id: "25",
    position: { x: 100, y: 1000 },
    data: { label: "New Input Types", icon: "✨" },
  },
  {
    id: "26",
    position: { x: 400, y: 1000 },
    data: { label: "APIs", icon: "⚙️" },
  },
