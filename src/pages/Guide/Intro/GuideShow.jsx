  ...
  return (
    <div className="flex flex-col p-4 mx-2 rounded-lg shadow-xl md:p-2 md:mx-3">
      <h1 className="mb-6 text-3xl font-bold">
        Archive <span className="text-purple-500 ">Guide</span>
      </h1>
      ...
      <div className="p-2 mb-6 bg-gray-800 border-l-4 border-purple-600 rounded-lg">
        ...
        <p className="text-gray-300 text-md">
          ...
          <a
            ...
            className="text-purple-400 underline transition duration-300 hover:text-purple-700"
            target="_blank"
