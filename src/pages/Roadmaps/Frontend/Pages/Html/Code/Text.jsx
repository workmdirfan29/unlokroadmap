...
const Text = () => {
  const codeString = `<h1>Main Heading</h1>
<h2>Subheading</h2>
<p>This is a <strong>bold</strong> text, <em>italic</em> text, and <u>underlined</u> text.</p>
<p>This is a new paragraph.<br>And this is a line break.</p>
`;
