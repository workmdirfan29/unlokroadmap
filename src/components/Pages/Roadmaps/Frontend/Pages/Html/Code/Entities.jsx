...
const Entities = () => {
  const codeString = `<h3>Special Characters</h3>
<p>&lt;div&gt; is how you create a div element in HTML.</p>
<p>Some common entities: &amp; (ampersand), &copy; (copyright), &hearts; (heart)</p>
`;
